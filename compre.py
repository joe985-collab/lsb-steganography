...
myMat = [[18,57,77,97,94,40,35,87], [65,24,25,40,95,87,75,42], [53,69,38,74,92,81,73,55],[48,53,47,77,41,51,14,42],[12,67,50,85,47,91,27,72],[63,37,31,94,70,42,98,33],[11,41,99,32,69,57,29,31],[79,26,65,79,66,23,57,13]]

test1 = p.zigzag(myMat)
test2 = zz.zigzag(np.array(myMat))
print(test1)
print("======================================================================================================")
print(test2)
print(p.inverse_zigzag(test1,8,8))
print(zz.inverse_zigzag(test2,8,8))
# pi = 0
# for d in test2:
#     print(d)
#     if d != test1[pi]:
